...
namespace Web.Controllers.Implements
{
    ...
    public class CredencialesController : ControllerBase
    {
        ...
        public CredencialesController(IAuthBusiness authBusiness, ILogger<CredencialesController> logger)
        {
        ...
        public async Task<ActionResult<AuthDto>> Login([FromBody] CredencialesDto credenciales)
        {
            try
            {
                ...
                var authResult = await _authBusiness.LoginAsync(credenciales);
